	...
	return (
		<>
			...
			<div className = "min-h-screen absolute overflow-hidden text-white max-w-full">
				<section id="hero" className = "min-h-screen background-mike_racecar">
					{timeLeft !== null ? (
						<>
							...
							<div className = "absolute flex flex-row w-full justify-center lg:gap-16 gap-4 lg:text-8xl text-5xl acumin text-center top-16">
								<div data-m = "bounce-down" data-m-delay = "1" id="days">{ timeLeft.days } <span className = "lg:text-4xl text-2xl block text-center">DAYS</span></div>
								<div data-m = "bounce-down" data-m-delay = "1.1" id="hours">{ timeLeft.hours } <span className = "lg:text-4xl text-2xl block text-center">HOURS</span></div>
								<div data-m = "bounce-down" data-m-delay = "1.2" id="minutes">{ timeLeft.minutes } <span className = "lg:text-4xl text-2xl block text-center">MINUTES</span></div>
								<div data-m = "bounce-down" data-m-delay = "1.3" id="seconds">{ timeLeft.seconds } <span className = "lg:text-4xl text-2xl block text-center">SECONDS</span></div>
							</div>
						</>
					) : ""}
